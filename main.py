...
from src.transform_data import validate_data_quality
...
e_airports = extract_airports()
#e_flights = extract_flights()

clean_airports_data = clean_airports(e_airports)
#clean_flights_data = clean_flights(e_flights)

validate_data_quality(clean_airports_data, 'airports')